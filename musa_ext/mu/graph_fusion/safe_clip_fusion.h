...
#ifndef TENSORFLOW_MUSA_EXTENSION_GRAPH_FUSION_SAFE_CLIP_FUSION_H_
#define TENSORFLOW_MUSA_EXTENSION_GRAPH_FUSION_SAFE_CLIP_FUSION_H_
...
class MusaSafeClipFusion : public FusionPattern {
 public:
  MusaSafeClipFusion();
  ~MusaSafeClipFusion() override = default;
...
#endif  // TENSORFLOW_MUSA_EXTENSION_GRAPH_FUSION_SAFE_CLIP_FUSION_H_
